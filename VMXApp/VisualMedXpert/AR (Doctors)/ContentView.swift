...
struct ContentView: View {
    ...
    var models: [String] = ["femaleSkeleton", "maleSkeleton", "humanHeart", "headStudy", "humanLungs", "humanBrain", "human_body", "human_kidney", "human_eye1", "human_skull", "human_stomach", "human_teeth", "female_torso", "human_mouth"]
    var modelLabels: [String] = ["Female Skeleton", "Male Skeleton", "Human Heart", "Head Study", "Human Lungs", "Human Brain", "Human Body", "Human Kidney", "Human Eye", "Human Skull", "Human Stomach", "Human Teeth", "Female Torso", "Human Mouth"]
